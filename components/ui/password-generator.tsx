...
export default function GeneratePasswordComponent() {
  ...
  const copyToClipboard = (): void => {
    navigator.clipboard.writeText(password).then(
      ...
      () => {
        alert("Failed to copy password to clipboard."); // Removed 'err' as it's unused
      }
    );
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-pink-100 dark:bg-gray-900">
      {/* Center the password generator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg transition-transform duration-300 hover:scale-105">
        <div className="mx-auto max-w-md space-y-6">
          ...
          <div className="space-y-4">
            ...
            <Button
              type="button"
              className="w-full bg-[#E7625F] hover:bg-[#1A4314] text-white"
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button
                  type="button"
                  className="bg-[#E7625F] hover:bg-[#1A4314] text-white"
      ...
      <footer className="absolute bottom-4 right-4 text-[#1A4314]">
        Made with <span style={{ color: "#8B0000" }}>♥</span> by Ayesha Mughal
      </footer>
    </div>
  );
}
